...
def take_off():
	navigate_wait(x=0.0, y=0.0, z=1.6, yaw=0.0, speed=0.2, frame_id='body',  auto_arm=True, tolerance=0.1)
	rospy.sleep(2)	

def nextMark(xc, yc):
	navigate_wait(x=float(xc), y=float(yc), z=1.6, yaw=0.0, speed=0.2, frame_id='body',  auto_arm=True, tolerance=0.1)
	rospy.sleep(1)
